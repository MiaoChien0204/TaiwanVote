...
**Ultimate Goal:** TaiwanVote aims to become a **comprehensive Taiwan election data retrieval interface**, expanding beyond recall elections to cover detailed historical data of all central and local public official elections, providing standardized and user-friendly interfaces for researchers and citizens.
...
**終極目標：** `TaiwanVote` 旨在成為一個**全面的臺灣選舉資料擷取介面**，不僅限於罷免案，更將擴展至涵蓋歷年來所有中央與地方公職人員選舉的詳盡數據，並提供標準化、易於使用的介面供研究者和公民取用。
...
The `level` parameter determines both data aggregation and how `is_elected`/`is_recalled` is calculated:
...
Future unified data retrieval functions with consistent `level` parameter:
...
+----------------+-------------------------------------------------------+---------------------------------------------------------------------+
| `office`       | Office type 職務類型                                  | `"president"` (總統)                                                |
|                |                                                       |                                                                     |
|                |                                                       | `"legislator"` (立法委員)                                           |
|                |                                                       |                                                                     |
|                |                                                       | `"mayor"` (縣市長)                                                  |
...
|                |                                                       | `"councilor"` (縣市議員)                                            |
+----------------+-------------------------------------------------------+---------------------------------------------------------------------+
| `level`        | Administrative level 行政層級                         | `"polling_station"` (投票所)                                        |
|                |                                                       |                                                                     |
|                |                                                       | `"village"` (村里)                                                  |
|                |                                                       |                                                                     |
|                |                                                       | `"town"` (鄉鎮市區)                                                 |
...
|                |                                                       | `"county"` (縣市)                                                   |
+----------------+-------------------------------------------------------+---------------------------------------------------------------------+
| `sub_type`     | Office subtype 職務子類型                             | `"regional"` (區域), `"indigenous"` (原住民), `"at_large"` (不分區) |
+----------------+-------------------------------------------------------+---------------------------------------------------------------------+
...
+----------------+-------------------------------------------------------+---------------------------------------------------------------------+
| `candidate`    | Candidate name 候選人姓名                             | `"鄭正鈐"`, `"蔡英文"`, `c("賴清德", "柯文哲")`                     |
+----------------+-------------------------------------------------------+---------------------------------------------------------------------+
| `party`        | Party name 政黨名稱                                   | `"中國國民黨"`, `"民主進步黨"`, `c("民主進步黨", "台灣民眾黨")`     |
+----------------+-------------------------------------------------------+---------------------------------------------------------------------+
...
-   `is_elected` / `is_recalled` (Winner status at specified administrative level 在指定行政層級的勝出狀態)
    - **Determined by `level` parameter**: Results calculated based on the specified administrative level
