...
-   `is_elected` / `is_recalled` (Winner status at selected administrative level 在所選行政區尺度的勝出狀態)
    - For elections: TRUE if candidate received most votes at the selected level
    - For recalls: TRUE if agree votes > disagree votes at the selected level
    - **Note**: Results vary by administrative scale (village vs. county level)
